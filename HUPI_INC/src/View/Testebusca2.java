...
public class Testebusca2 extends javax.swing.JFrame {
    ...
    private void jTable_vendaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_vendaMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            contador++ ;
             col = String.valueOf(jTable_venda.getValueAt(linha,1)) ;
            //String id = String.valueOf(jTable_venda.getValueAt(linha,0)) ;
            
            String unidade="unidade";
            String kg="kg";
            try {
                         stmt1 = con1.prepareStatement("Select * from lista where descricao='"+col+"'");
                        ...
                        if(medida.equals(unidade)){
                            ...
                            Tela_kg_unidade uni = new Tela_kg_unidade();
